...
function EndUserLicenseAgreement({ className }: Props) {
  return (
    <div className={className}>
      <h2 className="h3">End-User License Agreement</h2>
      <p>Last updated: May 24, 2019</p>
      <p>
        Please read this End-User License Agreement (“Agreement”) carefully
        before clicking the “I Agree” button, downloading or using Slasher
        (“Application”).
      </p>
      <p>
      ...
      <p>
        ...
        user on the app or website. In addition, we will not tolerate posting
        of any content we deem objectionable. Any user we determine to be
        doing so may be considered to be in violation of our terms. We reserve
      ...
      <p>
        ...
        as such terms are used under 48 C.F.R. §12.212 or 48 C.F.R. §227.7202,
        as applicable. In accordance with 48 C.F.R. §12.212 or 48 C.F.R.
