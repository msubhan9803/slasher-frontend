...
import DatingSetupAdditionalIdentifiers from './routes/dating/setup/additional-identifiers/DatingSetupAdditionalIdentifiers';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/dating/setup/additional-identifiers" element={<DatingSetupAdditionalIdentifiers />} />
