...
export const videoCreatorBusinessListingFactory = Factory.define<Partial<BusinessListing>>(({ sequence }) => new BusinessListing({
  businesstype: BusinessType.VIDEO_CREATOR,
  ...
  title: `Video Creator?! ${randomName}${sequence}`,
  overview: 'Horror Video Creator | Buy Now | Visit Website',
  isActive: true,
  bookRef: null,
  movieRef: null,
...
addFactoryToRewindList(videoCreatorBusinessListingFactory);
