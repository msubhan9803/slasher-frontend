...
describe('Feed-Comments / Likes Users of Comment  (e2e)', () => {
  ...
  describe('GET /api/v1/feed-comments/comment/:feedCommentId/users', () => {
    it('requires authentication', async () => {
      const feedCommentId = new mongoose.Types.ObjectId();
      await request(app.getHttpServer()).get(`/api/v1/feed-comments/comment/${feedCommentId}/users`).expect(HttpStatus.UNAUTHORIZED);
    });
