...
export const artistBusinessListingFactory = Factory.define<Partial<BusinessListing>>(({ sequence }) => new BusinessListing({
  ...
  title: `Artist?! ${randomName}${sequence}`,
...
addFactoryToRewindList(artistBusinessListingFactory);
