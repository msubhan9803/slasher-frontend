// Note: This script was used for migrating Chat schema data to the MatchList schema. The Chat
// schema does not exist anymore, so this script will not run anymore.  We will probably delete it
// in the near future, but it's being kept here for now for reference.
