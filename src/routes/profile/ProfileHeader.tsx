          ...
          <Row className="p-md-4">
            ...
            <Row className="d-flex ms-3">
              <CustomCol md={3} lg={12} xl="auto" className="text-center text-lg-center text-xl-start  position-relative">
                <AboutProfileImage height="11.25rem" width="11.25rem" src="https://i.pravatar.cc/300?img=12" className="rounded-circle" />
                {queryParam !== 'self'
                  && (
        ...
        : (
          <RoundDiv className="d-flex bg-dark justify-content-between p-md-3 p-2">
            <div className="d-flex">
              <div>
                <UserCircleImage width="3.125rem" height="3.125rem" src="https://i.pravatar.cc/300?img=12" className="rounded-circle me-2" />
              </div>
              <div>
