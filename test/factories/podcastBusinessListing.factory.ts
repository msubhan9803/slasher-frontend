...
export const podcastBusinessListingFactory = Factory.define<Partial<BusinessListing>>(({ sequence }) => new BusinessListing({
  businesstype: BusinessType.PODCASTER,
  ...
  title: `Podcast?! ${randomName}${sequence}`,
  overview: 'Horror Podcast | Buy Now | Visit Website',
  isActive: true,
  bookRef: null,
  movieRef: null,
...
addFactoryToRewindList(podcastBusinessListingFactory);
