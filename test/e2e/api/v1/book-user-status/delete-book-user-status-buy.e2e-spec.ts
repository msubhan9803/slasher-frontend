...
describe('Delete Book User Status Buy (e2e)', () => {
    ...
    describe('Delete /books/:bookId/lists/buy', () => {
        let book;
        beforeEach(async () => {
        ...
        it('successfully deleted a book user status buy', async () => {
            const response = await request(app.getHttpServer())
                .delete(`/books/${book.id}/lists/buy`)
