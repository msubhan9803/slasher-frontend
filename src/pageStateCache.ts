...
export const hasPageStateCache = (location: LocationType) => pageStateCache.has(getPageName(location));
export const getPageStateCache = <T = any>(location: LocationType): T => pageStateCache.get(getPageName(location));
export const setPageStateCache = <T>(location: LocationType, data: T) => pageStateCache.set(getPageName(location), data);
export const deletePageStateCache = (location: LocationType) => pageStateCache.delete(getPageName(location));
