...
import { BookUserStatusReadingList } from '../../../../../src/schemas/bookUserStatus/bookUserStatus.enums';
import { BookActiveStatus } from '../../../../../src/schemas/book/book.enums';

describe('Delete Book User Status Reading (e2e)', () => {
    ...
    describe('DELETE /books/:bookId/lists/readingList', () => {
        let book;
        beforeEach(async () => {
        ...
        it('successfully creates a add book user status readingList', async () => {
            const response = await request(app.getHttpServer())
                .delete(`/books/${book.id}/lists/readingList`)
        ...
        it('returns the expected response when the bookId is not found', async () => {
            ...
            const response = await request(app.getHttpServer())
                .delete(`/books/${bookId}/lists/readingList`)
                .auth(activeUserAuthToken, { type: 'bearer' })
                .send();
