...
// Below data mimics updated data on OpenLibrary for sync testing:
export const updatedMockBooksSearchQueryFromOpenLibrary = {
  numFound: 28278,
  start: 0,
  numFoundExact: true,
  docs: [
...
export const updatedKeyEditionData1 = {
  publishers: [
    '1st World Library - Literary Society',
  ],
  weight: '14.2 ounces',
...
export const updatedKeyEditionData2 = {
  publishers: [
    'Borgo Press',
  ],
  weight: '10.1 ounces',
