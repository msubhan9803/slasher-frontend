import {
 Cast, Crew, MainData, Result,
} from './movies.service';

export const moviesCasts: Cast[] = [{
  adult: false,
  gender: 2,
  id: 27888,
...
export const moviesResult: Result[] = [{
  iso_639_1: 'en',
  iso_3166_1: 'US',
...
export const moviesMainData: MainData[] = [{
  adult: false,
...
export const mockMovieDbCallResponse = {
  cast: moviesCasts, crew: moviesCrew, video: moviesResult, mainData: moviesMainData,
};
