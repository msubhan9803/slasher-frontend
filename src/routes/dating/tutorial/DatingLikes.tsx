...
import DatingLikesDesktop from '../../../images/dating-likes-desktop.jpg';
import DatingLikesMobile from '../../../images/dating-likes-mobile.jpg';
    ...
    <DatingPageWrapper>
      <div className="text-center p-3 mt-5 pt-5 mt-lg-0 pt-lg-3">
        ...
        <Row className="justify-content-center">
          <Col xs={8}>
            <TutorialIcon tutorialIcon={regular('heart')} iconColor="#FF1800" uniqueId="dating-messages" />
