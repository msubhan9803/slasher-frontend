...
describe('Add Book User Status Buy (e2e)', () => {
    ...
    describe('POST /books/:bookId/lists/buy', () => {
        let book;
        beforeEach(async () => {
        ...
        it('successfully creates a book user status buy', async () => {
            const response = await request(app.getHttpServer())
                .post(`/books/${book.id}/lists/buy`)
