  ...
  return (
    <div key={id}>
      ...
      <div style={{ marginLeft: `${userCircleImageSizeInRems + 0.5}rem` }}>
        <div
          className={`text-break ms-3 pt-3 px-3 pb-4 bg-dark rounded position-relative ${active ? 'border border-primary' : ''}`}
          ...
          </div>
          {
            ...
            && (
              <Likes className="rounded d-flex justify-content-end position-absolute">
                <LikesButton onClick={handleLikeCountClick} className="p-1 px-2 text-light me-2 mt-1 rounded-pill text-white">
