...
import UploadShoppingPhotos from './UploadShoppingPhotos';
      ...
      <Row>
        <Col md={6} lg={12} xl={6}>
          <div className="d-block d-md-flex align-items-center">
            <div className="d-flex justify-content-center me-md-2">
              <UploadShoppingPhotos id="profile-photo" />
            </div>
        ...
        <Col md={6} lg={12} xl={6} className="mt-5 mt-md-0 mt-lg-5 mt-xl-0">
          <div className="d-block d-md-flex align-items-center">
            <div className="d-flex justify-content-center me-md-2">
              <UploadShoppingPhotos id="cover-photo" />
            </div>
            <div className="text-center text-md-start mt-4 mt-md-0">
