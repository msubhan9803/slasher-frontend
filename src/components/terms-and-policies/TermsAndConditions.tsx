  ...
  return (
    <div className={className}>
      ...
      <p>
        ...
        monthly, a quarterly, a bi-annual, annual basis, or other duration we
        choose to offer, depending on the type of subscription plan you select
      ...
      <p>
        ...
        distribute such Content on and through the Service. You agree that this
      ...
      <p>
        ...
        user on the app or website. Any user we determine to be doing so may be
        considered to be in violation of our terms. We reserve the right to
      ...
      <p>
        ...
        to help@slasher.tv, with the subject line: “Copyright Infringement” and
