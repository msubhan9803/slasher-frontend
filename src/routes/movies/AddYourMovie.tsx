    ...
    <AuthenticatedPageWrapper rightSidebarType="profile-self">
      ...
      <div className="bg-dark px-md-4 py-4 py-md-5 rounded-3 bg-mobile-transparent">
        <div className="d-flex justify-content-between">
          <h2>Add your movie and reach horror fans looking for movies on Slasher!</h2>
        ...
        <div className="mt-1">
          ...
          <Text className="fs-4 mb-2">Here’s what you get:</Text>
        </div>
        <div>
            ...
            <Form>
              ...
              <Row className="">
                <Col md={4} className="mt-1">
                  <RoundButton className="w-100 p-1 fs-3" variant="primary" size="lg" type="submit">Submit</RoundButton>
                </Col>
              </Row>
