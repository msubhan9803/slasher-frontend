  ...
  return (
    <div className="bg-dark p-4 rounded-2 mt-3">
      ...
      <div className="d-flex align-items-center mt-3">
        <StyledSlideButton className="ps-0 prev bg-transparent border-0 shadow-none" onClick={slideCastsLeft}>
        ...
        <StyledSlideButton className="pe-0 next bg-transparent border-0 shadow-none" onClick={slideCastsRight}>
