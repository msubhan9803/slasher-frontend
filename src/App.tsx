...
import DatingSetupAdditionalIdentifier from './routes/dating/setup/DatingSetupAdditionalIdentifier';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/dating/setup/additional-identifier" element={<DatingSetupAdditionalIdentifier />} />
