...
import { BookUserStatusBuy } from '../../../../../src/schemas/bookUserStatus/bookUserStatus.enums';
import { BookActiveStatus } from '../../../../../src/schemas/book/book.enums';

describe('Delete Book User Status Favorite (e2e)', () => {
    ...
    describe('Delete /books/:bookId/lists/favorite', () => {
        let book;
        beforeEach(async () => {
        ...
        it('successfully deleted a book user status favorite', async () => {
            const response = await request(app.getHttpServer())
                .delete(`/books/${book.id}/lists/favorite`)
        ...
        it('returns the expected response when the bookId is not found', async () => {
            ...
            const response = await request(app.getHttpServer())
                .delete(`/books/${bookId}/lists/favorite`)
                .auth(activeUserAuthToken, { type: 'bearer' })
                .send();
